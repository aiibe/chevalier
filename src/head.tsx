// <head> machinery: the styles + page-head contexts, the <Head>/<Stylesheets>
// elements, and <PageHead> teleport. Split from layout.tsx so the title-dedup
// traversal (hasTitle/stripTitle) is isolated and independently testable.
